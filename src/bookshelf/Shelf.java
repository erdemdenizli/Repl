...
public class Shelf {
    ...
    public static boolean addBook(int id, String author, String title, int pages ){
    	...
    	if(isIDUnique(id) && !(title == "" || title.equals(null)) && pages > 0) {
    ...
    public static boolean addBook(Book book ){
      if(isIDUnique(book.getId()) && !(book.getTitle() == "" || book.getTitle().equals(null)) && book.getPages() > 0) {
    ...
    public static List<Book> getAllBooksForAuthor(String author) {
       ...
       for(int i=0; i<theBooks.size(); i++){
         if(theBooks.get(i).getAuthor().equals(author)) newList.add(theBooks.get(i));
      }
    ...
    public static void removeBook(int id) {
       for(int i=0; i<theBooks.size(); i++){
         if(theBooks.get(i).getId()==id) theBooks.remove(theBooks.get(i));
      }
    }
    ...
    public static void removeBook(String author) {
      ...
      for(int i=0; i<theBooks.size(); i++){
        if(theBooks.get(i).getAuthor().equalsIgnoreCase(author)){
          if(theBooks.remove(theBooks.get(i))) i--;
        }
      }
